...
.. note::
   ...
   1. **ISSI OSPI Flash (IS25WX256)** – 256 Mb.
   2. **Macronix Flash (MX66UW)** – 1 Gb. This flash device is supported only on the **E8 AppKit**, while the remaining DevKit variants use **ISSI flash**.

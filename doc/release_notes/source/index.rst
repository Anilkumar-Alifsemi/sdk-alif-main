...
.. list-table::
    ...
    * - 2.2
      - Updated the document to include OV5640 camera, TOF sensor, CAN-FD, OSPI Macronix Flash, HexSPI APMEM, Executorch support, EVTRTR driver, Basic Power Management (I2S, SPI, I2C, RTC, UART), and Deep Sleep IWIC support and clock control.
